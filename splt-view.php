...
foreach (get_plugins() as $key => $value) {
	if ($value['Name'] == 'NguonTV Collect Plugin') {
		$thisversion = $value['Version'];
	}
}
?>
<link href="<?php echo home_url(); ?>/wp-content/plugins/nguontv-collect/style.css" rel="stylesheet" type="text/css" />
<script src="<?php echo home_url(); ?>/wp-content/plugins/nguontv-collect/jquery-3.5.1.min.js" type="text/javascript"></script>
<script src="<?php echo home_url(); ?>/wp-content/plugins/nguontv-collect/main.js" type="text/javascript"></script>
<center>
	<h1>Nguon-TV</h1>
</center>
...
<div class="card">
	...
	<h5 class="card-title">API</h5>
		...
		?>
		<input type="hidden" id="path" name="path" value="<?php echo home_url(); ?>/wp-content/plugins/nguontv-collect/" required="required" />
